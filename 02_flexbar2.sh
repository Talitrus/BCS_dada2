...
#find . -name "*.fastq" -size -5M -exec mv '{}' flexbar_filtered/ \; #move files instead of deleting
find . -name "*.fastq" -size -300k -exec mv '{}' flexbar_filtered/ \; #adjustment for Friederike's libraries
#find . -name "*.fastq" -size -5M -delete #delete very small files from second stage of flexbar
mkdir logs
mv *.log logs/
