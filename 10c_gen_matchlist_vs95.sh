...
CENTROIDS_FILE="vsearch_size_centroid95.fasta"
NSLOTS=$(nproc)
...
blastn -db $CENTROIDS_FILE -outfmt '6 qseqid sseqid pident' -out matchlist_vs95.txt -qcov_hsp_perc 80 -perc_identity 84 -query $CENTROIDS_FILE -num_threads $NSLOTS
